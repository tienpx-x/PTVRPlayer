...
public struct CardboardParams {
    ...
    public let leftEyeMaxFov: CardboardFieldOfView
    ...
    internal init(root: Headset, data: Data) {
        ...
        leftEyeMaxFov = CardboardFieldOfView(angles: root.leftEyeFieldOfViewAngles)
    ...
    public init() {
        ...
        leftEyeMaxFov = CardboardFieldOfView(angles: [40, 40, 40, 40])
        compressedRepresentation = Data()
    }
