...
public class PTStereoScene: SCNScene {
    ...
    var orientationNode: PTOrientationNode?
...
extension PTStereoScene {
    ...
    public func updateOrientation(_ time: TimeInterval) {
        guard let orientationNode = orientationNode else { return}
...
extension PTStereoScene: PTVideoSceneDelegate {
    public func render(atHostTime time: TimeInterval, commandBuffer: MTLCommandBuffer) {
        guard let stereoTexture = stereoTexture else { return }
